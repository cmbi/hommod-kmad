...
public:
	...
	std::vector<std::string> performMSAencoded(std::vector<std::vector<double> >*,std::vector<std::vector<double> >*,double,std::string, bool, double, double);
private:
	//functions
	...
	void alignPairwise(std::vector<std::string> *,std::vector<std::string> *, std::vector<std::string>,std::vector<std::string>, Profile&, FeaturesProfile&, double, int,std::string,double);
