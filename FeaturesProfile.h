...
public:
	...
	double getGapOpeningPenalty(int,std::string);
	double getGapExtensionPenalty(int,std::string);
	...
	void createProfile(const std::vector< std::vector<std::string> >&,const std::vector<bool>&, const std::vector<double>&, bool, double);
...
private:
	...
	void countOccurences(const std::vector< std::vector<std::string> >&,const std::vector<bool>&,double);
